...
<head>
    ...
    <title>后台登录</title>
    <link rel="icon" href="loginSpecial/images/favicon.ico"
          type="image/x-icon"/>
    <link rel="shortcut icon" href="loginSpecial/images/favicon.ico"
          type="image/x-icon"/>
    <link href="loginSpecial/css/default.css" rel="stylesheet"
          type="text/css"/>
    <!--必要样式-->
    <link href="loginSpecial/css/styles.css" rel="stylesheet"
          type="text/css"/>
...
<div class='login'>
    ...
    <div class='login_fields'>
        ...
        <div class='login_fields__password'>
            ...
            <input name="pwd" class="passwordNumder" placeholder='密码'
                   maxlength="16" type='text' autocomplete="off" value="1">
            <div class='validation'>
                <img alt="" src='loginSpecial/img/tick.png'>
            </div>
        </div>
    ...
    <div class='disclaimer'>
        <p>欢迎登陆。。。<a style="color:blue" href="/toRegister">没有账号？点此注册</a></p>
    </div>
</div>
<div class='authent'>
    <div class="loader"
...
<link href="loginSpecial/layui/css/layui.css" rel="stylesheet"
      type="text/css"/>
...
<script type="text/javascript"
        src='loginSpecial/js/stopExecutionOnTimeout.js?t=1'></script>
